...
CREATE TABLE "AccountModel" (
    ...
    "currencyModelId" INTEGER NOT NULL,
...
CREATE TABLE "CurrencyModel" (
    ...
    CONSTRAINT "CurrencyModel_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CurrencyModel_code_key" ON "CurrencyModel"("code");

-- AddForeignKey
ALTER TABLE "AccountModel" ADD CONSTRAINT "AccountModel_currencyModelId_fkey" FOREIGN KEY ("currencyModelId") REFERENCES "CurrencyModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
